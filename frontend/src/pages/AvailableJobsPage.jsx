  ...
  const handleApply = async (jobId) => {
    try {
      ...
      const applicationData = {
        ...
        labourSkills: (job.requiredSkills && job.requiredSkills.length > 0) ? job.requiredSkills : ['general'],
              ...
              <div style={styles.jobContent}>
                ...
                <div style={styles.farmerInfo}>
                  ...
                  <span style={styles.rating}>
                    <svg viewBox="0 0 24 24" fill="#f59e0b" width="13" height="13" style={{ verticalAlign: 'middle', marginRight: 2 }}>
