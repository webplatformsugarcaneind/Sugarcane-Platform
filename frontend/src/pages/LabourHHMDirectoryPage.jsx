  ...
  return (
    <div className="hd-page">
      ...
      <div className="hd-kpi-row">
        ...
        <div className="hd-kpi a"><div className="hd-kpi-label">Active HHMs</div><div className="hd-kpi-val a">{kpiActive}</div><div className="hd-kpi-sub">Ready to hire</div></div>
      ...
      <div className={`hd-grid${isListView ? ' list-view' : ''}`}>
        {loading ? (
          ...
          <div className="hd-empty">
            ...
            <div className="hd-empty-title">{error}</div>
            <button className="hd-btn-profile" onClick={fetchHHMs} style={{ marginTop: '16px' }}>Try Again</button>
          </div>
        ) : filtered.length === 0 ? (
          ...
          <div key={hhm._id || `hhm-${idx}`} className={`hd-card ${hhm.isActive !== false ? 'active' : 'inactive'}`} style={{ animation: `hdFadeUp .6s var(--ease-out) both`, animationDelay: `${idx * 0.05}s` }}>
            <div className="hc-header">
              ...
              <div className="hc-title-wrap">
                ...
                <div className="hc-username">@{hhm.username || 'username'}</div>
            ...
            <div className="hc-actions">
              <button className="hd-btn-request" onClick={() => handleContact(hhm)} disabled={!hhm.email}>
              ...
              <button className="hd-btn-profile" onClick={() => navigate(hhm._id)}>
