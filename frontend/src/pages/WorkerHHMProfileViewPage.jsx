...
/**
 * WorkerHHMProfileViewPage Component
 * 
 * Displays detailed information about an HHM for workers
 */
                ...
                <div style={{
                    ...
                    <div style={{ flex: 1 }}>
                        ...
                        <p style={{
                            ...
                            {hhmData.description || 'Experienced Hub Head Manager coordinating agricultural operations and worker placement.'}
                        </p>
                    </div>
                </div>
            </div>
