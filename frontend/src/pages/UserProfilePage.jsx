            ...
            <div style={{ marginTop: '2rem', paddingTop: '2rem', borderTop: '2px solid #e9ecef' }}>
                <div style={{ 
                    ...
                    <h3 style={{
                        ...
                        👥 Associated HHMs ({user.associatedHHMs?.length || 0})
                    </h3>
                    <button
                        onClick={() => navigate(`/farmer/associate-hhm/${userId}`)}
                        style={{
                    ...
                    >
                        ⚙️ Manage HHM Associations
                    </button>
                </div>
                
                {user.associatedHHMs && user.associatedHHMs.length > 0 ? (
                    <div style={{ 
                        display: 'grid', 
                        gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', 
                        gap: '1rem' 
                    }}>
                        {user.associatedHHMs.slice(0, 6).map((hhm, index) => (
                            <div key={hhm._id || index} style={{
                                padding: '1rem',
                                background: '#f8fdf9',
                                ...
                                <div style={{ flex: 1 }}>
                                    ...
                                    {hhm.experience && (
                                        <div style={{ 
                                            ...
                                            🎯 {hhm.experience} years
                                        </div>
                                    )}
                                </div>
                            </div>
                        ))}
                        {user.associatedHHMs.length > 6 && (
                            <div style={{
                                padding: '1rem',
                                background: '#f0f8ff',
                            ...
                            >
                                <div style={{ textAlign: 'center' }}>
                                    ...
                                    <div style={{ fontWeight: '600', color: '#2196F3' }}>
                                        +{user.associatedHHMs.length - 6} more HHMs
                                    </div>
                    ...
                    <div style={{ 
                        ...
                        <div style={{ fontSize: '1rem', fontStyle: 'italic' }}>
                            No HHMs currently associated with this factory
                        </div>
                        <div style={{ fontSize: '0.9rem', marginTop: '0.5rem' }}>
                            Click "Manage HHM Associations" to add HHMs
                        </div>
                    </div>
                )}
            </div>
            ...
            <div style={{ marginTop: '2rem', paddingTop: '2rem', borderTop: '2px solid #e9ecef' }}>
                <div style={{ 
                    ...
                    <h3 style={{
                        ...
                        🏭 Associated Factories ({user.associatedFactories?.length || 0})
                    </h3>
                </div>
                
                {user.associatedFactories && user.associatedFactories.length > 0 ? (
                    <div style={{ 
                        display: 'grid', 
                        gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', 
                        gap: '1rem' 
                    }}>
                        {user.associatedFactories.slice(0, 6).map((factory, index) => (
                            <div key={factory._id || index} style={{
                                padding: '1.2rem',
                            ...
                            onClick={() => navigate(`/farmer/factory-directory/${factory._id}`)}
                            onMouseEnter={(e) => {
                            ...
                            onMouseLeave={(e) => {
                                ...
                                <div style={{
                                    ...
                                    📍 {factory.factoryLocation || factory.location || 'Location not specified'}
                                </div>
                        ...
                        {user.associatedFactories.length > 6 && (
                            <div style={{
                                padding: '1.2rem',
                                background: '#f8f9fa',
                                ...
                                +{user.associatedFactories.length - 6} more factories
                            </div>
                        )}
                    </div>
                ) : (
                    <div style={{
                        ...
                        <div style={{ fontSize: '1rem', fontStyle: 'italic' }}>
                            No factories currently associated with this HHM
                        </div>
                        <div style={{ fontSize: '0.9rem', marginTop: '0.5rem' }}>
                            Factories can add this HHM through their profile
                        </div>
                    </div>
                )}
            </div>
