  ...
  return (
    <div className="fd-page">
      ...
      <div className="fd-kpi-row">
        <div className="fd-kpi g"><div className="fd-kpi-label">Total Network</div><div className="fd-kpi-val g">{kpiTotal}</div><div className="fd-kpi-sub">Factories available</div></div>
        ...
        <div className="fd-kpi b"><div className="fd-kpi-label">Avg. Rating Score</div><div className="fd-kpi-val b">{kpiAvg}</div><div className="fd-kpi-sub">Network average</div></div>
          ...
          <div key={f._id || f.id || `f-${idx}`} className={`fd-card ${f.ui.rating}`} style={{ animation: `fdFadeUp .6s var(--ease-out) both`, animationDelay: `${idx * 0.05}s` }}>
            <div className="fc-header">
              ...
              <div className="fc-title-wrap">
                ...
                <div className="fc-location">📍 {f.location || 'Location not specified'}</div>
            ...
            <div className="fc-metrics">
              ...
              <div className="fc-metric"><div className="fcm-label">Capacity</div><div className="fcm-val muted">{f.capacity || 'N/A'}</div></div>
            ...
            <div className="fc-actions">
              ...
              <button className="fd-btn-profile" onClick={() => navigate(`/factory/factory-directory/${f._id || f.id}`)}>
