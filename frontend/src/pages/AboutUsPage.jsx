      ...
      <section className="about-section">
        <div className="container">
          <div className="section-header">
            <h2>Our Mission</h2>
            <p>
              To create a comprehensive digital ecosystem that connects farmers, factories, and labourers 
        ...
        <div className="container">
          ...
          <div className="features-grid">
            ...
            <div className="feature-card">
              ...
              <p>
                We connect agricultural labourers with verified job opportunities, 
