...
const HHMSentFactoryInvitationsPage = () => {
    ...
    return (<div className="hhm-sent-invitations-page"> <div className="page-header"> <h1>📤 Sent Factory Invitations</h1> <p className="subtitle">Track partnership requests you've sent to factories</p>
</div> {
            error && (<div className="alert alert-error"> <span className="alert-icon">⚠️</span> <span> {
                    error
                }
        ...
        <div className="invitations-container"> {
            filteredInvitations.length===0 ? (<div className="empty-state"> <div className="empty-icon">📭</div> <h3>No {
                    statusFilter !=='all'? statusFilter : ''
                }

                invitations found</h3> <p> {
                    statusFilter==='all'
                    ...
                    filteredInvitations.map((invitation)=> (<div key= {
                            ...
                            className="invitation-card"> <div className="card-header"> <div className="factory-info"> <h3> {
                                invitation.factoryId?.factoryName || invitation.factoryId?.name || 'Unknown Factory'
                            }

                            </h3> <p className="factory-location"> 📍 {
                            ...
                            > {
                            ...
                            </span> </div> <div className="card-body"> <div className="info-section"> <h4>📧 Contact Information</h4> <p>✉️ {
                                ...
                                invitation.personalMessage && (<div className="info-section"> <h4>💬 Your Message</h4> <p className="message-text"> {
                                ...
                                {
                                invitation.invitationReason && (<div className="info-section"> <h4>📝 Reason</h4> <p className="reason-text"> {
                                ...
                                {
                                invitation.responseMessage && (<div className="info-section response-section"> <h4>💭 Factory's Response</h4>
<p className="response-text"> {
                            ...
                            <div className="timeline-section"> <div className="timeline-item"> <span className="timeline-label">Sent:</span> <span className="timeline-value"> {
                                formatDate(invitation.createdAt)
                            }

                            </span> </div> {
                                invitation.respondedAt && (<div className="timeline-item"> <span className="timeline-label">Responded:</span> <span className="timeline-value"> {
