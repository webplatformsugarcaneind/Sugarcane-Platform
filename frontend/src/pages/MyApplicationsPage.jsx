              ...
              <div key={application._id} style={styles.applicationCard}>
                ...
                <div style={styles.applicationContent}>
                  <div style={styles.farmerInfo}>
                    ...
                    <span style={styles.rating}><svg viewBox="0 0 24 24" fill="#f59e0b" width="13" height="13" style={{verticalAlign:'middle',marginRight:2}}><path d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.006 5.404.434c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.434 2.082-5.005Z"/></svg> {application.farmer.rating}</span>
                  </div>
                    ...
                    <div style={styles.responseMessage}>
                      ...
                      {application.rating && (
                        <p style={styles.completionRating}>
                          Your Rating: {Array.from({length: application.rating}).map((_, i) => <svg key={i} viewBox="0 0 24 24" fill="#f59e0b" width="15" height="15" style={{verticalAlign:'middle'}}><path d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.006 5.404.434c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.434 2.082-5.005Z"/></svg>)}
                        </p>
                      )}
                    </div>
                  )}
